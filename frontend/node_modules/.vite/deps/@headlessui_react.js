    ...
    this.getMeasurements = memo(
      ...
      ({ count: count2, paddingStart, scrollMargin, getItemKey, enabled }, itemSizeCache) => {
        ...
        for (let i18 = min2; i18 < count2; i18++) {
          ...
          const size3 = typeof measuredSize === "number" ? measuredSize : this.options.estimateSize(i18);
...
function Ae({ children: e8, enabled: t13 = true }) {
  ...
  let { refs: b11, floatingStyles: S10, context: g8 } = useFloating2({ open: i18, placement: a27 === "selection" ? p12 === "center" ? "bottom" : `bottom-${p12}` : p12 === "center" ? `${a27}` : `${a27}-${p12}`, strategy: "absolute", transform: false, middleware: [offset2({ mainAxis: a27 === "selection" ? 0 : E17, crossAxis: A6 }), shift2({ padding: c18 }), a27 !== "selection" && flip2({ padding: c18 }), a27 === "selection" && h11 ? inner({ ...h11, padding: c18, overflowRef: u24, offset: l16, minItemsVisible: D2, referenceOverflowThreshold: c18, onFallbackChange(P7) {
    var L8, N2;
    if (!P7) return;
  ...
  } }) : null, size2({ padding: c18, apply({ availableWidth: P7, availableHeight: d14, elements: M9 }) {
