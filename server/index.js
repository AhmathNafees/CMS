...
import sCustomerRouter from './routes/sCustomer.js'
...
app.use(express.static('public/indexCustomerCV'))
app.use(express.static('public/indexCustomers'))
...
app.use('/api/sCustomer',sCustomerRouter)
